...
public class pet {
  ...
  /**
   * This method is called when a food item is given to the pet.
  ...
  /**
   * this method takes the pet out of the sleeping state
   */
  public void awake() {
    this.sleeping = false;
  }
  ...
  /**
   * Getter method to determine if pet is asleep
   * @return true if pet is sleeping, false otherwise
   */
  ...
  /**
   * getter method to find score value
   * @return score
   */
  public int getScore() {
    return score;
  ...
  /**
   * this method decreases a given vital stat by a given amount
   * @param multiplier the amount
   * @param value the stat you wish to decrease
   */
  ...
  /**
   * decrease fullness by a given amount
   * @param multiplier
   */
  ...
  /**
   * decrease happiness by a given amount
   * @param multiplier
   */
  ...
  /**
   * decrease energy by a given amount
   * @param multiplier
   */
